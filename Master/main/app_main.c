...
/*PARA MANDAR A THINGSBOARD*/
extern const uint8_t mqtt_caroot_pem_start[]   asm("_binary_caroot_pem_start");
extern const uint8_t mqtt_cert_pem_start[]   asm("_binary_cert_pem_start");
extern const uint8_t mqtt_key_pem_start[]   asm("_binary_key_pem_start");



static const char *TAG_MQTT = "MQTTS_EXAMPLE";
static const char *MESH_TAG = "MESH_EXAMPLE";
static uint8_t MESH_ID[6] = { 0x11, 0x11, 0x11, 0x11, 0x11, 0x11};
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        esp_mqtt_client_publish(client, "v1/devices/me/telemetry", "{\"temperature\":58}", 0, 1, 0);
        break;
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        .broker = {
            .address.uri = "mqtts://mqtt.thingsboard.cloud:8883",
            .verification.certificate = (const char *)mqtt_caroot_pem_start,
        },
        .credentials = {
            .authentication = {
                .certificate = (const char *)mqtt_cert_pem_start,
                .key = (const char *) mqtt_key_pem_start,
            }
        }
    };
